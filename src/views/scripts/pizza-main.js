...
var selectRandomNonMeat = function() {
  var randomNonMeat = pizzaIngredients.nonMeats[parseInt(Math.random() * pizzaIngredients.nonMeats.length)];
  return randomNonMeat;
};

var selectRandomCheese = function() {
  var randomCheese = pizzaIngredients.cheeses[parseInt(Math.random() * pizzaIngredients.cheeses.length)];
  return randomCheese;
};

var selectRandomSauce = function() {
  var randomSauce = pizzaIngredients.sauces[parseInt(Math.random() * pizzaIngredients.sauces.length)];
  return randomSauce;
};

var selectRandomCrust = function() {
  var randomCrust = pizzaIngredients.crusts[parseInt(Math.random() * pizzaIngredients.crusts.length)];
  return randomCrust;
};
...
var makeRandomPizza = function() {
  ...
  var numberOfMeats = parseInt(Math.random() * 4);
  var numberOfNonMeats = parseInt(Math.random() * 3);
  var numberOfCheeses = parseInt(Math.random() * 2);
  ...
  return pizza + ingredientItemizer(selectRandomSauce()) + ingredientItemizer(selectRandomCrust());
};
...
var pizzaElementGenerator = function(i) {
  ...
  pizzaName.style = "text-transform: capitalize";
...
function updatePositions() {
  ...
  var base = [
      100 * Math.sin(position),
      100 * Math.sin(position + 1),
      100 * Math.sin(position + 2),
      100 * Math.sin(position + 3),
      100 * Math.sin(position + 4)
  ];
  for (var i = 0; i < items.length; i++) {
    items[i].style.left = items[i].basicLeft + base[i % 5] + 'px';
  }
